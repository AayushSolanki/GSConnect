...
import 'package:flutter_application_1/chats/conversation.dart';
            ...
            child: TextFormField(
              ...
              onChanged: (query) {
                try {
                  ...
                  showInSnackBar("Not found", context);
                }
              },
              decoration: InputDecoration(
                ...
                contentPadding: EdgeInsets.only(bottom: 4.0, left: 10.0),
                //  contentPadding: EdgeInsets.fromLTRB(20.0, 10.0, 20.0, 10.0),
                border: InputBorder.none,
                counterText: '',
                hintText: 'Search with Name or Batch ',
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return ListTile(
                  ...
                  subtitle: Text("Batch -${user.passingyear!}"),
